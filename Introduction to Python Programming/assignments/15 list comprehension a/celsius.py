...
''' (2 Points) Write a function called celsiusFahrenheitList1
...
def celsiusFahrenheitList():
    ...
    '''
    return [(i,((( i * 9 ) / 5 ) + 32)) for i in range(0, 101, 5)]
...
def celsiusFahrenheitListConfigurable(start, end, stepsize):
    ...
    return [(i,((( i * 9 ) / 5 ) + 32)) for i in range(start, end+1, stepsize)]

# This automatically tests your code
if __name__ == "__main__":
    import doctest
    doctest.testmod(verbose=True)
    # print(celsiusFahrenheitListConfigurable(50, 60, 1))
