...
# and a PDF file with the class diagrams!

# The class diagram should show a) the class hierarchy as well as b) the
...
def display_zoo():
    ...
    for animal in zoo_animals:
        # Note: the __str__ method of animal will be called automatically when
