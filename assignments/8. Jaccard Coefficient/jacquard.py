...
Implement a function "jacquard" that measures the similarity of two texts, where each text is represented as a string. 
For the computation of the jacquard index, you should represent the texts as sets (i.e., you should ignore number of times a specific word occurs in the text). 
